...
exports.default = {
    ...
    create: function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var emailService, mailerTo, mailerMessage;
            return __generator(this, function (_a) {
                emailService = new EmailService_1.default();
                mailerTo = { name: 'bla', email: 'bla@email.com' };
                mailerMessage = { subject: 'foo bar', body: 'e ai pessoal tudo bem aqui quem fala é o edu' };
